                ...
                ->arrayNode('hosts')
                    ...
                    ->children()
                        ->arrayNode('internal')
                            ...
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Entity\Incident\Host\HostInternal')
                                ->end()
                                ->arrayNode('handler')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('class')
                                            ->defaultValue('CertUnlp\NgenBundle\Services\Api\Handler\Incident\Host\HostInternalHandler')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('form_type')
                                    ...
                                    ->children()
                                        ->scalarNode('class')
                                            ->defaultValue('CertUnlp\NgenBundle\Form\Incident\Host\HostInternalType')
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
                        ...
                        ->arrayNode('external')
                            ...
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Entity\Incident\Host\HostExternal')
                                ->end()
                                ->arrayNode('handler')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('class')
                                            ->defaultValue('CertUnlp\NgenBundle\Services\Api\Handler\Incident\Host\HostExternalHandler')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('form_type')
                                    ...
                                    ->children()
                                        ->scalarNode('class')
                                            ->defaultValue('CertUnlp\NgenBundle\Form\Incident\Host\HostExternalType')
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
                        ...
                        ->arrayNode('factory')
                            ...
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Services\Host\HostFactory')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
                ...
                ->arrayNode('incidents')
                    ...
                    ->children()
                        ...
                        ->arrayNode('handler')
                            ...
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Services\Api\Handler\Incident\IncidentHandler')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('delegator_chain')
                            ...
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Services\Delegator\IncidentDelegatorChain')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_type')
                        ...
                        ->arrayNode('mailer')
                            ->children()
                                ->scalarNode('class')
                                    ->defaultValue('CertUnlp\NgenBundle\Services\Mailer\IncidentMailer')
                                ->end()
